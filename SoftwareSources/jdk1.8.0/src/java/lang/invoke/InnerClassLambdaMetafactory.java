...
/* package */ final class InnerClassLambdaMetafactory extends AbstractValidatingLambdaMetafactory {
    ...
    private final boolean isSerializable;            // Should the returned instance be serializable
    private final Class[] markerInterfaces;          // Additional marker interfaces to be implemented
    ...
    public InnerClassLambdaMetafactory(MethodHandles.Lookup caller,
            ...
            throws ReflectiveOperationException {
        // Regrettably duplicated code block -- if changed, change in all constructors
        ...
        // End of regrettably duplicated code block
    ...
    /**
     * Alternate meta-factory constructor, allowing for uncommon options such as serialization.
     *
     * @param caller Stacked automatically by VM; represents a lookup context with the accessibility privileges
     *               of the caller.
     * @param invokedType Stacked automatically by VM; the signature of the invoked method, which includes the
    ...
    public InnerClassLambdaMetafactory(MethodHandles.Lookup caller,
        ...
        for (Class c : markerInterfaces) {
            if (!c.isInterface()) {
                throw new LambdaConversionException(String.format("Class %s is not an interface", c.getName()));
            }
