...
/**
 * A return object which may or may not contain a <code>double</code> value. If a value is present
...
public final class OptionalDouble {
     ...
     * @return the value if present otherwise return result of {@code other}.
     */
    public double orElse(DoubleSupplier other) {
     ...
     */
    public<V extends Throwable> double orElseThrow(Supplier<V> exceptionFactory) throws V {
        if (isPresent) {
            return value;
        } else {
    ...
    public String toString() {
        return isPresent ? String.format("DoubleOptional[%s]", value) : "DoubleOptional.empty";
    }
}
