 ...
 * </table>
 *
 * The default bootstrap ({@link #metaFactory}) represents the common cases and uses an optimized protocol.  Alternate
 * bootstraps (e.g., {@link #altMetaFactory}) exist to support uncommon cases such as serialization.
 *
 */
